...
class Paper(models.Model):
    translator = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, verbose_name='مترجم')
    title = models.CharField(max_length=255, verbose_name='موضوع')
    content = models.TextField(verbose_name='محتوا')
    image = models.ImageField(upload_to='guide/', default='guide/default.jpg', verbose_name='تصویر')
